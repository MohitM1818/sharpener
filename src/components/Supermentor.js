    ...
    <div>
      ...
      {mentor.map((d)=>
        <div className='supermentor-slide'>
          ...
          <img className='company-image' src={d.companyimage} alt='company '></img>
